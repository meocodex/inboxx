...
export const IconeCanal = memo(({
  ...
  const renderIcon = () => {
    switch (canal) {
      case TipoCanal.WHATSAPP:
        return <WhatsAppIcon size={size} className="text-whatsapp" />;
      case TipoCanal.INSTAGRAM:
        return <InstagramIcon size={size} className="text-instagram" />;
  ...
  const getBgClass = () => {
    switch (canal) {
      case TipoCanal.WHATSAPP:
        return 'bg-whatsapp/15';
      case TipoCanal.INSTAGRAM:
        return 'bg-instagram/15';
      case TipoCanal.FACEBOOK:
...
IconeCanal.displayName = 'IconeCanal';
